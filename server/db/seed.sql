...
('Life of Brian', 1979, 'https://cdn.shopify.com/s/files/1/1416/8662/products/Life_of_Brian_1979_original_film_art_5000x.jpg?v=1569037982', 'Terry Jones', 'Graham Chapman', 'Eric Idle', 'UK');
...
((SELECT peplum.peplum_id FROM peplum WHERE title LIKE '%Life of Brian%'), 'Yes, its peplum');